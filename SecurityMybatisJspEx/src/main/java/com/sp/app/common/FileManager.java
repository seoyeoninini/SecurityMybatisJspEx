...
public class FileManager {
	 ...
	 */
	public String doFileUpload(MultipartFile partFile, String pathname) throws IOException {
	 ...
	 * @return 서버에 저장된 새로운 파일의 이름
	 */
	public String doFileUpload(byte[] bytes, String originalFilename, String pathname) throws IOException {
		String saveFilename = null;
	 ...
	 * @return					서버에 저장된 새로운 파일의 이름
	 */
	public String doFileUpload(InputStream is, String originalFilename, String pathname) throws IOException {
		String saveFilename = null;
		FileOutputStream fos = null;
	...
	public boolean doFileDownload(String saveFilename, String originalFilename, String pathname, HttpServletResponse resp) {
		...
		try {
			...
			int read;
			while ((read = bis.read(readByte, 0, BUFFER_SIZE)) != -1) {
	...
	public boolean doZipFileDownload(String[] sources, String[] originals, String zipFilename, HttpServletResponse resp) {
		...
		try {
			...
			// 파일 다운로드
			flag = doFileDownload(archiveFilename, zipFilename, pathname, resp);
	 ...
	 * @return 압축된 파일명
	 */
	public String fileCompression(String[] sources, String[] originals, String pathname) throws IOException {
